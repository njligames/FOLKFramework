//
//  UIWindow+Traverse.swift
//  FOLKFramework
//
//  Created by James Folk on 2/4/22.
//
...
extension UIWindow {
    ...
    /// - Parameter visitor: The closure executed for every view object in the hierarchy.
    /// - Parameter responder: The view object, `UIView`, `UIViewController`, or `UIWindow` instance.
    /// - Parameter level: The depth level in the view hierarchy.
        ...
        while !stack.isEmpty {
            ...
            switch current.responder {
                ...
                case let window as UIWindow:
                    stack.append((responder: window, level: current.level + 1))
                default:
                    break
            }
